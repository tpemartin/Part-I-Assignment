...
```{r}
library(readr)
pums <- read_csv("https://raw.githubusercontent.com/wachuang/Part-I-Assignment/master/pp.csv")
```
...
summary(out1)
```
educ的係數為27.746，大於0，代表多受教育可使平均薪資提高。
...
college係數可能會因為某些遺漏變數未被考慮而有偏估的現象。