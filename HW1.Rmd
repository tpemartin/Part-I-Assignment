...
```{r}
library(readr)
pums <- read.csv("https://raw.githubusercontent.com/changmengchin/Part-I-Assignment/710561116/pp.csv")
...
pums %>% ggplot(aes(x=educ,y=wklywge,group=educ),wit)+
  geom_boxplot() -> A
A
# 高中畢業的outliers最多
